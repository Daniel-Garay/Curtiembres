...
public class ProductoOutInventario {
    ...
    public ProductoOutInventario() {
    }

    public ProductoOutInventario(int codigo, String descripcion, boolean activo, String codUnidadMedida) {
        this.codigo = codigo;
